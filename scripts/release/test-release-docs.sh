...
require_text "AGENT_SECRET_IN_MISE=1 scripts/build/test-build-entitlements.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/release/test-release-signing-env.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/release/test-release-ancestry.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/release/test-release-notes.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/release/test-release-publish.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/release/test-release-version.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/release/test-release-docs.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/checks/test-public-docs.sh"
require_text "AGENT_SECRET_IN_MISE=1 scripts/checks/test-workflow-actions-pinned.sh"
require_text "swift run agent-secret-app-smoke"
require_text "scripts/release/check-release-signing-env.sh"
